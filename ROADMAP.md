...
- [Milestone v0.9.2 — Advanced Features](#milestone-v060--advanced-features)
- [Milestone v0.9.2 — Agentic Execution Patterns](#milestone-v070--agentic-execution-patterns)
- [Non-Goals](#non-goals)
...
## Milestone v0.9.2 — Advanced Features
...
## Milestone v0.9.2 — Agentic Execution Patterns
...
- [ ] **`CopilotSdkWrapper.on('step', handler)`** — stream individual agent steps as they execute (builds on the `on(eventType, handler)` planned in v0.9.2)
...
| High-level intent delegation (`runTask`) | ✅ (v0.9.2) | ❌ |
| Event-driven execution triggers | ✅ (v0.9.2) | ❌ |
| Observable execution (`on('step' \| 'tool_call')`) | ✅ (v0.9.2) | ❌ |
| Background service embedding (`AgentService`) | ✅ (v0.9.2) | ❌ |
