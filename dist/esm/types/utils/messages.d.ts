 ...
 */
export declare function createFunctionMessage(name: string, content: string): Message;
/**
 ...
 */
export declare function extractContent(message: Message): string;
/**
 ...
 */
export declare function hasRole(message: Message, role: MessageRole): boolean;
/**
 ...
 */
export declare function filterByRole(messages: Message[], role: MessageRole): Message[];
