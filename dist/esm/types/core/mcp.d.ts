 ...
 * ```
 */
export declare function createLocalMCPServer(config: LocalMCPServer): LocalMCPServer;
/**
 ...
 * ```
 */
export declare function createRemoteMCPServer(config: RemoteMCPServer): RemoteMCPServer;
export {};
